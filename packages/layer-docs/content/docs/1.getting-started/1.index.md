...
This template is a ready-to-use documentation template made with [Nuxt UI](https://ui.nuxt.com), a collection of premium components built on top of [Nuxt UI](https://ui.nuxt.com) to create beautiful & responsive Nuxt applications in minutes.
